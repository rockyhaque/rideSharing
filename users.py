...
class Ride_Matching:
    ...
    def find_driver(self, ride_request):
        if len(self.available_drivers) > 0:
            ...
            rider = Rider(ride_request.rider.current_location, ride_request.end_location)
...
run = Ride_Sharing('Niye Jao')
ali = Rider("Ali Baser", 'alibaser@gmail.com', 1254, 'Mohakhali', 1200)
run.add_rider(ali)
manik_bhai = Driver('Manik Mojomdar', 'manik@gmail.com', 5648, 'Gulshan 1')
run.add_driver(manik_bhai)
print(run)
ali.request_ride(run, 'Uttara')
ali.show_current_ride()